...
parser.add_argument("--guide_model",
                    default="none",
                    type=str,
                    choices=["none", "cg", "cf", "control"],   # cg = classifier guide, cf = classifier free, control = controlnet
                    help="the type of guided model")
parser.add_argument("--noise_model",
                    default="gru",
                    choices=["gru", "trm", "unet", "unet1d", "unet2d", "wave"],
                    type=str,
...
parser.add_argument("--ema",
                    default=False,
                    action="store_true",
                    help="whether use the ema in DDIM")
parser.add_argument("--ema_rate",
                    default=0.9999,
                    type=float,
                    help="the rate of ema")
